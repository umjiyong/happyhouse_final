...
function displayMarkers(places) {
	...
	for(var i=0; i<places.length; i++) {
		...
		var placePosition = new kakao.maps.LatLng(parseFloat(places[i].lat), parseFloat(places[i].lng));
		...
		(function (marker, title, code, place, imgIdx) {
			kakao.maps.event.addListener(marker, "click", function () {
				displayInfowindow(marker, title, place, imgIdx);
			});
		...
		})(marker, places[i].aptName, places[i].aptCode, places[i], i);
...
//인포윈도우에 장소명을 표시합니다
function displayInfowindow(marker, title, place, imgIdx) {
	var content = `
		<div class="overlaybox">
			<div class="boxtitle">${title}</div>
			<div class="first"><img src="../assets/img/apt${imgIdx%6}.png" style="width:247px; height:136px;" alt=""></div>
			<ul>
				<li class="up">
				...
				<li>
					...
					<span class="count">${place.dealAmount} (만원)</span>
				</li>
				<li>
